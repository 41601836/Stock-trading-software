...
public class RunPerformanceTest {
    ...
    public static void main(String[] args) {
        ...
        // 运行所有性能测试
        testDynamicThresholdCalculationPerformance();
        testSwingDecisionEnginePerformance();
        testDTWPerformance();
        testKlinePatternRecognitionPerformance();
     ...
     */
    private static void testDynamicThresholdCalculationPerformance() {
     ...
     */
    private static void testSwingDecisionEnginePerformance() {
     ...
     * 测试K线形态识别的性能
     */
    private static void testKlinePatternRecognitionPerformance() {
     ...
     * 生成随机交易数据
     */
    private static TradeData generateRandomTradeData() {
        String stockCode = "SH600000";
        int price = 1000 + random.nextInt(200);
     ...
     * 生成随机股票筹码数据
     */
    private static StockChip generateRandomStockChip() {
     ...
     * 生成随机K线数据
     */
    private static List<Kline> generateRandomKlines(int count) {
